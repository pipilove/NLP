...
from ABSA.absa import Splitter, POSTagger
...
def LastPatterns():
    ...
    for text in reviews:
        ...
        # KnownAspects = ['phone', 'phones', 'nokia', 'features', 'service', 'radio', 'quality', 'speakerphone', 'battery', 'screen'] #下式频率TOP10
        # KnownAspects = ['phone', 'phones', 'nokia', 'features', 'service', 'radio', 'quality', 'speakerphone', 'battery', 'screen', 'sound', 'camera', 'size', 'life', 'feature', 'reception', 'voice', ')', 'excellent', 't-zones']  #TOP20
        ...
        for p in patterns:
            Patterns.append(p)
    P = [key for key, value in Counter(Patterns).items() if value>1]
    return P
